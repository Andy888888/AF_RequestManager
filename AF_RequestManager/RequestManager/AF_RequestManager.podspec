...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/Andy888888/AF_RequestManager"
  ...
  s.source       = { :git => "https://github.com/Andy888888/AF_RequestManager.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "AF_RequestManager/RequestManager", "RequestManager/**/*.{h,m}"
